...
ADD CONSTRAINT PK_AuthorsBooks FOREIGN KEY (AuthorId) REFERENCES Authors (AuthorId);

ALTER TABLE AuthorsBooks
ADD CONSTRAINT PK_BooksAuthors FOREIGN KEY (BookId) REFERENCES Books (BookId);
