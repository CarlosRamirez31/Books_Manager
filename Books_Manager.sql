...
ADD CONSTRAINT PK_AuthorsBooks FOREIGN KEY (AuthorId) REFERENCES Authors (AuthorId) ON DELETE CASCADE;

ALTER TABLE AuthorsBooks
ADD CONSTRAINT PK_BooksAuthors FOREIGN KEY (BookId) REFERENCES Books (BookId) ON DELETE CASCADE;

ALTER TABLE Comments
ADD CONSTRAINT PK_Comments FOREIGN KEY (BookId) REFERENCES Books (BookId) ON DELETE CASCADE;
